...
function Product({ img, title = '' }: ProductProps) {
    return (
        <Item
            initial={{ filter: 'grayscale(100%)' }} whileInView={{ filter: 'grayscale(0%)' }} transition={{ duration: 0.5 }} viewport={{ once: false, amount: 'all' }}>
...
function Shop() {
    ...
    return (
        <Section ref={sectionRef} id="shop">
            ...
            <Left>
                <p>
                    The brand new collection is currently being developed in ITA.
                    We create our products using best quality material, invluding the use of some of the pure fabrics to make our products.
