    ...
    return (
        <Section id="fixed-target" className="about">
            ...
            <Left data-scroll data-scroll-sticky data-scroll-target="#fixed-target">
                We're fashion studio based in Italy.
            ...
            <Right>
                ...
                <img src={img2} alt="About Us" className="small-img-1" data-scroll data-scroll-speed="5" />
                <img src={img3} alt="About Us" className="small-img-2" data-scroll data-scroll-speed="-2" />
            </Right>
        </Section>
    )
}
